...
export default function Home() {
  return (
    <main className="flex flex-col flex-1 items-center px-3 py-4 sm:px-6 sm:py-8 gap-4">
      <header className="w-full max-w-3xl flex flex-wrap items-baseline justify-between gap-2">
        <div>
      ...
      <footer className="w-full max-w-3xl text-xs text-dim flex flex-wrap justify-between gap-2">
        <span>
          digital-lluc is an AI version of me — enjoy it, then check the real
          record on LinkedIn.
        </span>
